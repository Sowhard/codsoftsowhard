...
class TodoListApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Sowhard To-Do List")
        self.geometry("400x400")
        self.task_input = ttk.Entry(self, font=("TkDefaultFont", 16), width=30)
        self.task_input.pack(pady=10)
        self.task_input.insert(0, "Enter your todo list here...")
    ...
    def add_task(self):
        ...
        if task_text and task_text != "Enter your todo list here...":
            self.tasks.append({"text": task_text, "done": False})
            self.task_list.insert(tk.END, task_text)
            self.task_list.itemconfig(tk.END, fg="blue")
    ...
    def clear_placeholder(self, event):
        if self.task_input.get() == "Enter your todo list here...":
            self.task_input.delete(0, tk.END)
